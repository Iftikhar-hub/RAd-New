    ...
    return (
      <>
        <section className="hidden max-[1922px]:overflow-hidden max-w-[1920px] mx-auto xl:block absolute inset-0 w-full h-[480px] top-[162px]    -z-100">
          ...
          <div className="Twoxl-1 hidden  xl:block  w-full absolute max-w-[906px] h-[906px] bg-[#06B6D4] left-[-236px] top-[152px] rounded-[100%] border border-[#FFFFFF] blur-[200px] opacity-[10%]"></div>
