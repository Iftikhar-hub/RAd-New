...
const Varriation = () => {
    return (
      <>
        <section className="hidden max-[1922px]:overflow-hidden max-w-[1920px] mx-auto sm:block absolute inset-0 w-full h-[550px] top-[150px]    -z-10">
          ...
          <div className="Twoxl-1 hidden sm:block  w-full absolute max-w-[869px] h-[869px] bg-[#06B6D4] left-[0] top-[152px] rounded-[100%] border border-[#FFFFFF] blur-[250px] opacity-[5%]"></div>

          <div className="Twoxl-1 hidden  sm:block  w-full absolute max-w-[906px] h-[906px] bg-[#06B6D4] left-[-236px] top-[152px] rounded-[100%] border border-[#FFFFFF] blur-[200px] opacity-[10%]"></div>
